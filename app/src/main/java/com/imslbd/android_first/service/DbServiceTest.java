...
public class DbServiceTest {
    ...
    public static String selectStr() throws Exception {
        return JsonToSqlParser.selectStr(new JSONArray()
    ...
    public static void joinStrTestSingle() {
        try {
            StringBuilder stringBuilder = JsonToSqlParser.joinStr(new JSONArray(Arrays.asList(
    ...
    public static String orderByTest() throws Exception {
        return JsonToSqlParser.orderByStr(new JSONArray(Arrays.asList(
    ...
    public static String whereTest() throws Exception {
        return JsonToSqlParser.whereStr(
    ...
    public static String toSqlTest() throws Exception {
        return JsonToSqlParser.toSqlQuery(
            new JSONObject()
                ...
                .put("groupBy", new JSONArray()
                    ...
                    .put(new JSONObject().put("br_id", "b"))), new ArrayList<String>());
    }
